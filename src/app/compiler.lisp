...
(defun compile-equal (expr asm)
    (let ((expr-s2s (ntobin expr)))
        ...
        `((JEQ ,etiq-true) (MOVE nil :R0)(JMP ,etiq-fin)(LABEL ,etiq-true)(MOVE t :R0)(LABEL ,etiq-fin) )
        )
        )
    )
)
...
(defun compile-lower (expr asm)
    (let ((expr-s2s (ntobin expr)))
        ...
        (append (compile-lisp operand1 asm) (compile-lisp operand2 asm) '((POP :R1)(POP :R0)(CMP :R0 :R1))
        `((JLT ,etiq-true) (MOVE nil :R0)(JMP ,etiq-fin)(LABEL ,etiq-true)(MOVE t :R0)(LABEL ,etiq-fin) )
        )
        )
    )
)
...
(defun compile-bigger (expr asm)
    (let ((expr-s2s (ntobin expr)))
        ...
        (append (compile-lisp operand1 asm) (compile-lisp operand2 asm) '((POP :R1)(POP :R0)(CMP :R0 :R1))
        `((JGT ,etiq-true) (MOVE nil :R0)(JMP ,etiq-fin)(LABEL ,etiq-true)(MOVE t :R0)(LABEL ,etiq-fin) )
        )
        )
    )
)
...
(defun compile-lower-equal (expr asm)
    (let ((expr-s2s (ntobin expr)))
        ...
        (append (compile-lisp operand1 asm) (compile-lisp operand2 asm) '((POP :R1)(POP :R0)(CMP :R0 :R1))
        `((JLE ,etiq-true) (MOVE nil :R0)(JMP ,etiq-fin)(LABEL ,etiq-true)(MOVE t :R0)(LABEL ,etiq-fin) )
        )
        )
    )
)
...
(defun compile-bigger-equal (expr asm)
    (let ((expr-s2s (ntobin expr)))
        ...
        (append (compile-lisp operand1 asm) (compile-lisp operand2 asm) '((POP :R1)(POP :R0)(CMP :R0 :R1))
        `((JGE ,etiq-true) (MOVE nil :R0)(JMP ,etiq-fin)(LABEL ,etiq-true)(MOVE t :R0)(LABEL ,etiq-fin) )
        )
        )
    )
)
...
(print (compile-lisp '(>= (+ 8 7 (- 5 (* 5 7 8 (/ 2 5))))5) '()))
